...
static Sys_var_uint Sys_max_session_cursors(
       "max_session_cursors",
       "The maximum number of open SYS_REFCUROR allowed per session",
       SESSION_VAR(max_session_cursors), CMD_LINE(REQUIRED_ARG),
